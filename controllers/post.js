...
export const getPosts = (req, res) => {
    ...
    const q = `SELECT p.id, username,title,description,p.img,other_category,date,flag FROM posts p JOIN users u ON u.id=p.user_id WHERE flag=? and category LIKE '${search_category_value}%'  ORDER BY id desc `;
